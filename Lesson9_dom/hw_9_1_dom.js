...
for (const element of coursesArray) {
    ...
    modules.classList.add('blueBox','modules');
    div.classList.add('redBox');
    title.classList.add('blueBox','title');
    month.classList.add('blueBox','month');
    hours.classList.add('blueBox','hours');
    duration.classList.add('flex');
    for (const item of element.modules) {
        let li=document.createElement('li');
        li.innerText=`${item}`;
        ul.appendChild(li);
        li.classList.add('blueBox','li');
    }
    title.innerText=`Title: ${element.title}`;
    month.innerText=`Months: ${element.monthDuration}`;
    hours.innerText=`Hours: ${element.hourDuration}`;
